...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1588: (o, p) => p in o,
      _1589: (o, p) => o[p],
      _1609: () => new AbortController(),
      _1610: x0 => x0.abort(),
      _1611: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1612: (x0,x1) => globalThis.fetch(x0,x1),
      _1613: (x0,x1) => x0.get(x1),
      _1614: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1614(f,arguments.length,x0,x1,x2) }),
      _1615: (x0,x1) => x0.forEach(x1),
      _1616: x0 => x0.getReader(),
      _1617: x0 => x0.cancel(),
      _1618: x0 => x0.read(),
      _1631: x0 => x0.random(),
      _1632: (x0,x1) => x0.getRandomValues(x1),
      _1633: () => globalThis.crypto,
      _1634: () => globalThis.Math,
      ...
      _2185: (x0,x1) => { x0.download = x1 },
      _2210: (x0,x1) => { x0.href = x1 },
      _3532: () => globalThis.window,
      _3573: x0 => x0.document,
      _6139: x0 => x0.signal,
